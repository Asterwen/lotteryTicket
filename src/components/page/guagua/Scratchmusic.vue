<template>
	<div class="Scratchmusic">
		...
		<img src="../../../assets/image/WechatIMG11.png" @click="imageData()" class="Scratchmusic_footer" v-show="isFlag"/>
	</div>
</template>
...
//			 })
		...
		methods:{
			...
			Imgtop(){
				...
				$(".Scratchmusic_main").css("opacity","1")
			},
			fetchData() {
				let params = {}
				params.gglType = 10
...
<style lang="scss">
	.Scratchmusic {
		...
		height: 100vh;
		min-height: 100%;
		background: url("../../../assets/image/WechatIMG15.png") no-repeat;
		background-size: 100%;
		overflow: hidden;
	}
	/*.guajiang{
